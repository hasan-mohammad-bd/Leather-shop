...
const Answers = () => {
    return (
        <div className='writing'>
            ...
            <p>Answers: React is a frameWork of JavaScript which helps to build user interfaces. It very effective tools to make single page applications and mobile supported apps.React can build complex apps in very effectively using declarative code.
                <br /><br />
            ...
            unlike borwser's DOM elements,React elements are plain objects and very easy to create. React virtual DOM update DOM to match the react element. this is the reason, JS is very fast to update the DOM elements and speed up its manipulation.           <h2>What is the different between props and state?</h2>
            <p>Answer: </p>
            <h4>there are some difference between props and state as below:</h4>
